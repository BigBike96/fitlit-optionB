...
describe.only('Activity', () => {
  ...
  it('should return average steps taken for given date for all users', () => {
    expect(activity.getAllUserAverageForDay("2019/06/23", userRepo, "numSteps")).to.eql(9000)
  });

  it('should return average minutes active given date for all users', () => {
    expect(activity.getAllUserAverageForDay("2019/06/23", userRepo, "minutesActive")).to.equal(8)
  });
